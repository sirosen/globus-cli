...
password in plain-text in your command history.* Give a password to use with
--myproxy, skipping the password prompt.
...
----
$ ep_id=2fa7dd54-0f40-11e7-bb43-22000b9a448b
